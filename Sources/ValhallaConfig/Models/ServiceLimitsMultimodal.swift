...
public struct ServiceLimitsMultimodal: Codable, JSONEncodable, Hashable {
    ...
    public var maxMatrixLocationPairs: Int? = 0

    public init(maxDistance: Int? = 500_000, maxLocations: Int? = 50, maxMatrixDistance: Int? = 0, maxMatrixLocationPairs: Int? = 0) {
